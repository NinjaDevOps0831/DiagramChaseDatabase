...
class UI {
    constructor(element) {
        ...
        window.parent.quiverUi = this;
        window.parent.quiverHistory = history;
    }
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    const load_quiver_from_json = (data) => {
        ...
        if (data != null) {
            try {
                // Decode the diagram.
                QuiverImportExport.json.import(ui, data);
    ...
    window.parent.quiverLoadDiagram = load_quiver_from_json;
